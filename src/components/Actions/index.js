...
const Actions = ({ className, id, tokenId, account, owner, isListing, isPack, isETH, price, setSuccess, setError }) => {
  ...
  return (
    <>
      ...
      >
        <RemoveSale id={id} account={account} isPack={isPack} price={price} isETH={isETH} setSuccess={setSuccess} setError={setError} />
      </Modal>
      <Modal
